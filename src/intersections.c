...
{
	// if (game->data->map[get_block_index2(game, &inter, flag).index] != game->data->map[get_block_index3(game, &inter, flag)])
	// {
	// 	printf ("get_block_index2(game, &inter, flag) is %d\n", get_block_index2(game, &inter, flag).index);
	// 	printf ("get_block_index3(game, &inter, flag) is %d\n", get_block_index3(game, &inter, flag));
	// }
	// else 
	// 	printf ("the same\n");
